...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'C:\Users\demon\Documents\Pycharm_projects\Seaborn_Titanic_Dataset_Preprocessing'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'C:\Users\demon\Documents\Pycharm_projects\Seaborn_Titanic_Dataset_Preprocessing\Scripts\deactivate.nu'
